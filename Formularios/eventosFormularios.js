...
//Envento change
//Nos permite detectar cuado hay un cambio en el valor de un input, select o textarea. Se ejecuta cuando cambiamos el valor del input y damos click fuera.
...
formulario.correo.addEventListener('focus', () => {
    console.log('El input correo ahora es el foco de antención');
});
...
formulario.correo.addEventListener('blur', () => {
    console.log('El input correo ya no es el foco de antención');
});

//Evento keydown
//Nos permite detectar cuando una tecla es presionada al escribir sobre un input
